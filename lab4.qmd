...
```
Answer: the p-value (2.2e-16) is less than 0.05 which indicates that their is a significant relationship between forest type and channel unit.
...
wilcox.test(weight_g ~ section, data = salamander_data)


```
Answer: The p-value for the wilcox test was (9.57e-07) which is less than 0.05. This indicates that there is a significant difference in species biomass between clear cut and old growth forest types
...
```
Answer: Since the p-value (2.2e-16) is less than 0.05, the data indicates that there is a significant correlation between body mass and body length
...
```
Answer: A simple linear regression was conducted to examine the effect of annual variation in water temperature (water_temp_sd) on carapace width. The model was not significant (F(1, 390) = 0.3999, p = 0.5275), explaining R² = 0.001024 of the variance in carapace width. The regression coefficient for water_temp_sd was B = 0.09938 (p = 0.528), indicating that for each unit increase in temperature variation, carapace width increased/decreased by about 0.1 mm.
...
```
Answer: The correlation matrix revealed that latitude and air_temp_sd were correlated (r = 0.79), while latitude and water_temp_sd showed almost no correlation (r = 0.04). The relationship between air_temp_sd and water_temp_sd was weakly correlated (r = 0.41), suggesting low multicollinearity concerns.
...
```
Answer: A multiple linear regression was conducted to examine the effects of latitude, air temperature variation (air_temp_sd), and water temperature variation (water_temp_sd) on crab size. The overall model was significant (F(3, 388) = 70.13, p = 2.2e-16), explaining R² = 0.35 of the variance in size.
